...
export default function AcceptJobButton({ jobId }: { jobId: string }) {
  ...
  async function handleAccept() {
    ...
    // Notify the sender. The action takes only the booking id and resolves
    // the recipient + details server-side after checking we're the carrier —
    // nothing sensitive is passed from the browser.
